...
#include "global.h"
#include "../bsw/labboard/sevenSegment.h"
 ...
 */
//RC_t FILE_function();
RC_t validateBtnPress(unsigned short randomNum);


/**
 * Will process the event for the state machine
 * \param CTRL_event_t ev                : [IN] the event
 * \return void
 */
