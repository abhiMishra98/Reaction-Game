...
typedef struct {
    uint8_t red;     // Intensity of Red LED (0-255)
    uint8_t green;   // Intensity of Green LED (0-255)
    uint8_t blue;    // Intensity of Blue LED (0-255)
    uint16_t time;   // Duration in milliseconds for this color combination
} RG_Glow_t;

extern const RG_Glow_t RG_glowtable_1[];
extern const size_t RG_glowtable_1_len;
