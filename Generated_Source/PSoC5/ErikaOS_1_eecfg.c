 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_timeDelay) */
    #endif
    ...
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_fader) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_timeDelay*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_timer*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_fader*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_timeDelay */
    #endif
    #if EE_MAX_TASK > 4
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alrm_randomTime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alrm_Timer, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
