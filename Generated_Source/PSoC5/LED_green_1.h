...
/* Interrupt constants */
#if defined(LED_green_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
     ...
     *  @{
     */
        #define LED_green_1_INTR_NONE      (uint16)(0x0000u)
        #define LED_green_1_INTR_RISING    (uint16)(0x0001u)
        #define LED_green_1_INTR_FALLING   (uint16)(0x0002u)
        #define LED_green_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define LED_green_1_INTR_MASK      (0x01u) 
#endif /* (LED_green_1__INTSTAT) */
...
/* SIO registers */
#if defined(LED_green_1__SIO_CFG)
    #define LED_green_1_SIO_HYST_EN        (* (reg8 *) LED_green_1__SIO_HYST_EN)
    #define LED_green_1_SIO_REG_HIFREQ     (* (reg8 *) LED_green_1__SIO_REG_HIFREQ)
    #define LED_green_1_SIO_CFG            (* (reg8 *) LED_green_1__SIO_CFG)
    #define LED_green_1_SIO_DIFF           (* (reg8 *) LED_green_1__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define LED_green_1_0_INTTYPE_REG 		(* (reg8 *) LED_green_1__0__INTTYPE)
#endif /* (LED_green_1__INTSTAT) */
